"""
This code is identical to the YOLOv8_Explainer/utils.py file created by 
Sarma Borah, Proyash Paban and Kashyap, Devraj and Laskar, Ruhini Aktar and Sarmah, and Ankur Jyoti

The original python code is available at: https://github.com/Spritan/YOLOv8_Explainer/

All the credits for the code goes to the original authors. We leave the citation of the original work below:

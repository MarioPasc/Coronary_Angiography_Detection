...
#SBATCH --time=1-00:00:00    # Request 1 day of runtime, adjust as needed
#SBATCH --mem=32G            # Request 32 GB of memory, adjust based on your dataset size
#SBATCH --ntasks=1           # Run a single task
#SBATCH --cpus-per-task=4    # Request 4 CPUs for the task, adjust as needed
#SBATCH --error=logs/dataset_gen.%J.err  # Standard error log file
#SBATCH --output=logs/dataset_gen.%J.out # Standard output log file
...
source activate ica_detection

# Define the path to your scripts and config file
SCRIPT_DIR="/home/mpascual/research/projects/Coronary_Angiography_Detection/scripts"
